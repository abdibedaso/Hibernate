    ...
    public static SessionFactory getSessionFactory(List<Class> entityClasses) {
        ...
        if (sessionFactory == null) {
            try {
                ...
                settings.put(Environment.URL, "jdbc:sqlserver://localhost:1433;databaseName=ea_course;");
                settings.put(Environment.USER, "abditufa");
                settings.put(Environment.PASS, "P@ss4%db%");
